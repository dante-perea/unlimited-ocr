"""Typed pydantic models for the NCBI / PMC Open Access responses.

These are the wire contract for ``GET /ncbi/search``, ``GET /ncbi/paper/{pmcid}``
and ``POST /ncbi/fetch/{pmcid}`` (see ``app.routers.ncbi``).
"""
...
class FetchResponse(BaseModel):
    ...
    filename: Optional[str] = Field(default=None, description="Name of the cached PDF file.")
    size_bytes: Optional[int] = Field(default=None, description="Size of the cached PDF in bytes.")
